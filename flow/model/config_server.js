...
declare type mattermost$ServerConfig$ServiceSettings = {
    ...
    RestrictCustomEmojiCreation: 'all' | 'admin' | 'system_admin',
    RestrictPostDelete: mattermost$Permission$TeamManagement,
...
declare type mattermost$ServerConfig$TeamSettings = {
    ...
    RestrictTeamInvite: mattermost$Permission$TeamManagement,
    RestrictPublicChannelManagement: mattermost$Permission$ChannelManagement,
    RestrictPrivateChannelManagement: mattermost$Permission$ChannelManagement,
    RestrictPublicChannelCreation: mattermost$Permission$TeamManagement,
    RestrictPrivateChannelCreation: mattermost$Permission$TeamManagement,
    RestrictPublicChannelDeletion: mattermost$Permission$ChannelManagement,
    RestrictPrivateChannelDeletion: mattermost$Permission$ChannelManagement,
    RestrictPrivateChannelManageMembers: mattermost$Permission$ChannelManagement,
